            ...
            <main class="p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-4">
                        <a href="/dashboard/quizzes" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700">
                            Create New Quiz
                        </a>
            ...
            .then(data => {
                data.data.forEach((quiz) => {
                    ...
                    <div class="flex justify-between">
                        ...
                        <button class="text-green-600 hover:text-green-800" onclick="copyContent('${data.unique_value}')" >Share</button>
